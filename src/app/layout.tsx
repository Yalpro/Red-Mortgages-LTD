...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://red-mortgages-ltd.vercel.app/Meta_image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Red Mortgages LTD provides expert mortgage, protection and insurance advice from Liverpool.",
    images: ["https://red-mortgages-ltd.vercel.app/Meta_image.png"],
  },
  alternates: {
    canonical: "https://red-mortgages-ltd.vercel.app",
  },
  robots: {
    index: true,
    follow: true,
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "image": "https://red-mortgages-ltd.vercel.app/Meta_image.png",
    "@id": "https://red-mortgages-ltd.vercel.app/#localbusiness",
    "url": "https://red-mortgages-ltd.vercel.app",
  ...
  return (
    <html lang="en" className={`${inter.variable} ${playfair.variable}`}>
      <head>
        <meta property="og:image" content="https://red-mortgages-ltd.vercel.app/Meta_image.png" />
